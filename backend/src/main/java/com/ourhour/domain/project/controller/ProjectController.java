...
public class ProjectController {
        ...
        public ResponseEntity<ApiResponse<PageResponse<MileStoneInfoDTO>>> getProjectMilestones(
                ...
                ApiResponse<PageResponse<MileStoneInfoDTO>> response = projectService.getProjectMilestones(orgId,
                                projectId, myMilestonesOnly, pageable);
        ...
        public ResponseEntity<ApiResponse<Void>> deleteMilestone(
                ...
                ApiResponse<Void> response = milestoneService.deleteMilestone(orgId, milestoneId);
                return ResponseEntity.ok(response);
        }
        ...
        public ResponseEntity<ApiResponse<IssueDetailDTO>> updateIssue(
                ...
                ApiResponse<IssueDetailDTO> response = issueService.updateIssue(orgId, issueId,
                                issueReqDTO);
